...
public class LuffyProperties : MonoBehaviour
{
    private float _damage = 100.0f;
    private float _defense = 0f;
    private float _health = 2500.0f;
    ...
    private float _cooldownIntrinsic = 5; // 5
    private float _cooldownSkill01 = 10; // 10
    private float _cooldownSkill02 = 10; // 10
    private float _cooldownSkill03 = 15; // 15
    private float _cooldownSkill04 = 12; // 12

    private float _manaIntrinsic = 50;
    private float _manaSkill01 = 150;
    private float _manaSkill02 = 150;
    private float _manaSkill03 = 300;
    private float _manaSkill04 = 200;

    private float _damIntrinsic = 50;
    private float _damSkill01 = 150;
    private float _damSkill02 = 150;
    private float _damSkill03 = 300;
    private float _damSkill04 = 200;
    ...
    void Start()
    {
        ...
        {
            _titleIntrinsic = "Gomu Gomu no Mi";
            _titleSkill01 = "Gomu Gomu no Rifle";
            _titleSkill02 = "Gomu Gomu no Bazooka";
            _titleSkill03 = "Gomu Gomu no Gatling Gun";
            _titleSkill04 = "Gear Third";

            _descriptionIntrinsic = "Luffy tăng tầm đánh và tăng " + _damIntrinsic + " sát thương cho đòn đánh thường kế tiếp.";
            _descriptionSkill01 = "Luffy đưa cánh tay ra phía sau và xoáy nó, sau đó ném ra một cú đấm mạnh mẽ, gây " + _damSkill01 + " sát thương và đẩy đối thủ ra xa.";
            _descriptionSkill02 = "Luffy đưa 2 cánh tay ra phía sau, sau đó ném ra một cú đấm mạnh mẽ, gây " + _damSkill02 + " sát thươngvà đẩy đối thủ ra xa.";
            _descriptionSkill03 = "Luffy sẽ tấn công liên tục trong 3 giây, và gây tổng cộng " + _damSkill03 + " sát thương trong 1.5 giây.";
            _descriptionSkill04 = "Luffy sẽ phóng 1 bộ phận cơ thể của mình, tăng tầm đánh và gây " + _damSkill04 + " sát thương.";
    ...
    public void SetInfoSkill()
    {
        ...
        _imageIntrinsicFrame.sprite = Resources.Load<Sprite>("SkillLuffy/Intrinsic");
        _imageSkill01Frame.sprite = Resources.Load<Sprite>("SkillLuffy/Skill01");
        _imageSkill02Frame.sprite = Resources.Load<Sprite>("SkillLuffy/Skill02");
        _imageSkill03Frame.sprite = Resources.Load<Sprite>("SkillLuffy/Skill03");
        _imageSkill04Frame.sprite = Resources.Load<Sprite>("SkillLuffy/Skill04");
    }
