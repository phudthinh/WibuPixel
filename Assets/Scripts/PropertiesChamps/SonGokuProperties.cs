...
public class SonGokuProperties : MonoBehaviour
{
    private float _damage = 80.0f;
    private float _defense = 0f;
    private float _health = 2000.0f;
    private float _healing = 1.0f;
    private float _mana = 1500.0f;
    private float _restoreMana = 3.0f;
    ...
    private float _cooldownIntrinsic = 0;
    private float _cooldownSkill01 = 5; // 5s
    private float _cooldownSkill02 = 15; // 15s
    private float _cooldownSkill03 = 20;  // 20s
    private float _cooldownSkill04 = 30; // 30s

    private float _manaIntrinsic = 0;
    private float _manaSkill01 = 100;
    private float _manaSkill02 = 200;
    private float _manaSkill03 = 200;
    private float _manaSkill04 = 500;

    private float _damSkill01 = 100;
    private float _damSkill02 = 300;
    ...
    void Start()
    {
        ...
        {
            _titleIntrinsic = "Kích nộ";
            _titleSkill01 = "Ki Blast";
            _titleSkill02 = "Spirit Bomb";
            ...
            _descriptionSkill04 = "Goku phóng một luồng năng lượng mạnh mẽ, gây " + _damSkill04 + " sát thương trong vòng 3s.";
    ...
    public void SetInfoSkill()
    {
        ...
        _imageIntrinsicFrame.sprite = Resources.Load<Sprite>("SkillSonGoku/Intrinsic");
        _imageSkill01Frame.sprite = Resources.Load<Sprite>("SkillSonGoku/Skill01");
        _imageSkill02Frame.sprite = Resources.Load<Sprite>("SkillSonGoku/Skill02");
        _imageSkill03Frame.sprite = Resources.Load<Sprite>("SkillSonGoku/Skill03");
        _imageSkill04Frame.sprite = Resources.Load<Sprite>("SkillSonGoku/Skill04");
    }
