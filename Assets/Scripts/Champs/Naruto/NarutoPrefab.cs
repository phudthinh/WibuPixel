...
public class NarutoPrefab : MonoBehaviourPunCallbacks
{
    ...
    private bool _skill03Dash;

    private float _timeCooldownIntrinsic = 5;
    ...
    private void UpdateProperties()
    {
        if(_timeCooldownIntrinsic <= 0)
        {
            ...
            _photonView.RPC("SetIntrinsic", RpcTarget.All);
    ...
    private void Jump()
    {
        ...
        if (Input.GetKeyDown(_keyJump) && _hitWaitTime <= 0 && !_skill01 && !_skill02 && !_skill03 && !_skill04 && !_intrinsic)
        {
            if (_isGrounded)
            {
                ...
                if(randomVoice == 1)
                {
                    GameObject _voice = PhotonNetwork.Instantiate("SkillNaruto/VoiceJump", transform.position, Quaternion.identity);
                    StartCoroutine(DetroyObject(_voice, 5.0f));
                }
                GameObject _sound = PhotonNetwork.Instantiate("SkillNaruto/SoundJump", transform.position, Quaternion.identity);
    ...
    private void Attack()
    {
        ...
        if(Input.GetKeyDown(_keyAttack) && _attackWaitTime <= 0 && _hitWaitTime <= 0 && !_dash && !_skill01 && !_skill02 && !_skill03 && !_skill04 && !_intrinsic)
        {
            ...
            if(_isGrounded)
            {
                ...
                {
                    randomVoice = Random.Range(1, 3);
                    GameObject _sound = PhotonNetwork.Instantiate("SkillNaruto/SoundAttack01", transform.position, Quaternion.identity);
                    StartCoroutine(DetroyObject(_sound, 5.0f));
                    if(randomVoice == 1)
                    {
                        GameObject _voice = PhotonNetwork.Instantiate("SkillNaruto/VoiceAttack01", transform.position, Quaternion.identity);
                        StartCoroutine(DetroyObject(_voice, 5.0f));
                    }
                ...
                {
                    randomVoice = Random.Range(1, 3);
                    GameObject _sound = PhotonNetwork.Instantiate("SkillNaruto/SoundAttack02", transform.position, Quaternion.identity);
                    StartCoroutine(DetroyObject(_sound, 5.0f));
                    if(randomVoice == 1)
                    {
                        GameObject _voice = PhotonNetwork.Instantiate("SkillNaruto/VoiceAttack02", transform.position, Quaternion.identity);
                        StartCoroutine(DetroyObject(_voice, 5.0f));
                    }
                ...
                {
                    randomVoice = Random.Range(1, 3);
                    GameObject _sound = PhotonNetwork.Instantiate("SkillNaruto/SoundAttack03", transform.position, Quaternion.identity);
                    StartCoroutine(DetroyObject(_sound, 5.0f));
                    if(randomVoice == 1)
                    {
                        GameObject _voice = PhotonNetwork.Instantiate("SkillNaruto/VoiceAttack03", transform.position, Quaternion.identity);
                        StartCoroutine(DetroyObject(_voice, 5.0f));
                    }
                ...
                {
                    randomVoice = Random.Range(1, 3);
                    GameObject _sound = PhotonNetwork.Instantiate("SkillNaruto/SoundAttack04", transform.position, Quaternion.identity);
                    StartCoroutine(DetroyObject(_sound, 5.0f));
                    if(randomVoice == 1)
                    {
                        GameObject _voice = PhotonNetwork.Instantiate("SkillNaruto/VoiceAttack04", transform.position, Quaternion.identity);
                        StartCoroutine(DetroyObject(_voice, 5.0f));
                    }
    ...
    private void Spell()
    {
        if (Input.GetKeyDown(_keySpell) && _timeCooldownSpell == 0 && !_skill01 && !_skill02 && !_skill03 && !_skill04)
        {
            ...
            if(this.gameObject.tag == "Player01")
            {
                ...
                {
                    PhotonNetwork.Instantiate("SpellGame/DashNaruto", new Vector2(transform.position.x, transform.position.y + 0.3f), Quaternion.identity);
                    _rb.gravityScale = 0;
                    _rb.linearVelocity = new Vector2(0, 0);
                    transform.position = new Vector2(transform.position.x + 3.0f * transform.localScale.x, transform.position.y);
                    currentState = State.Dash;
                    _dash = true;
                    GameObject _sound = PhotonNetwork.Instantiate("SkillNaruto/SoundDash", transform.position, Quaternion.identity);
                    StartCoroutine(DetroyObject(_sound, 5.0f));
    ...
    private void Skill01()
    {
        ...
        if(Input.GetKeyDown(_keySkill01) && _attackWaitTime <= 0 && _hitWaitTime <= 0 && !_dash && _timeCooldownSkill01 == 0 && !_skill01 && !_skill02 && !_skill03 && !_skill04)
        {
            ...
            _skill01 = true;
            randomVoice = Random.Range(1, 3);
            GameObject _sound = PhotonNetwork.Instantiate("SkillNaruto/SoundSkill01", transform.position, Quaternion.identity);
            StartCoroutine(DetroyObject(_sound, 5.0f));
            if(randomVoice == 1)
            {
                GameObject _voice = PhotonNetwork.Instantiate("SkillNaruto/VoiceSkill01", transform.position, Quaternion.identity);
                StartCoroutine(DetroyObject(_voice, 5.0f));
            }
            _rb.gravityScale = 0;
            _rb.linearVelocity = new Vector2(0, 0);
            if(_isGrounded)
            {
                ...
                if(transform.localScale.x == 1)
                    _photonView.RPC("ShowPowerSkill01", RpcTarget.All, new Vector2(transform.position.x, transform.position.y + 0.2f), new Vector2(0.5f, 0.5f), 10f, 1);
                else
                    _photonView.RPC("ShowPowerSkill01", RpcTarget.All, new Vector2(transform.position.x, transform.position.y+ 0.2f), new Vector2(-0.5f, 0.5f), 10f, 1);    
                }
            else
            {
                ...
                {
                    _photonView.RPC("ShowPowerSkill01", RpcTarget.All, new Vector2(transform.position.x, transform.position.y + 0.2f), new Vector2(0.5f, 0.5f), 10f, 1);
                    _photonView.RPC("ShowPowerSkill01", RpcTarget.All, new Vector2(transform.position.x, transform.position.y + 0.2f), new Vector2(0.5f, 0.5f), 10f, 2);
                    _photonView.RPC("ShowPowerSkill01", RpcTarget.All, new Vector2(transform.position.x, transform.position.y + 0.2f), new Vector2(0.5f, 0.5f), 10f, 3);
                }
                else
                {
                    _photonView.RPC("ShowPowerSkill01", RpcTarget.All, new Vector2(transform.position.x, transform.position.y+ 0.2f), new Vector2(-0.5f, 0.5f), 10f, 1); 
            ...
            StartCoroutine(TimeUnSkill01(0.1f));
        }
    }
    ...
    private void Skill02()
    {
        ...
        if(Input.GetKeyDown(_keySkill02)  && _attackWaitTime <= 0 && _hitWaitTime <= 0 && !_dash && _timeCooldownSkill02 == 0 && !_skill01 && !_skill02 && !_skill03 && !_skill04 && _isGrounded)
        {
            if(this.gameObject.tag == "Player01")
            {
            ...
            _skill02 = true;
            GameObject _sound = PhotonNetwork.Instantiate("SkillNaruto/SoundSkill02", transform.position, Quaternion.identity);
            StartCoroutine(DetroyObject(_sound, 5.0f));
            _rb.linearVelocity = new Vector2(0, 0);
            _rb.gravityScale = 0;
    ...
    private void Skill03()
    {
        ...
        if(Input.GetKeyDown(_keySkill03)  && _attackWaitTime <= 0 && _hitWaitTime <= 0 && !_dash && _timeCooldownSkill03 == 0 && !_skill01 && !_skill02 && !_skill03 && !_skill04 && _isGrounded)
        {
            if(this.gameObject.tag == "Player01")
            {
            ...
            _skill03 = true;
            randomVoice = Random.Range(1, 3);
            GameObject _sound = PhotonNetwork.Instantiate("SkillNaruto/SoundSkill03", transform.position, Quaternion.identity);
            StartCoroutine(DetroyObject(_sound, 5.0f));
            if(randomVoice == 1)
            {
                GameObject _voice = PhotonNetwork.Instantiate("SkillNaruto/VoiceSkill01", transform.position, Quaternion.identity);
            ...
            StartCoroutine(TimeSkill03Dash(2.1f));
            StartCoroutine(TimeUnSkill03(3.0f));
        }
        if(_skill03 && _skill03Dash)
        {
            if(transform.localScale.x == 1)
                _rb.linearVelocity = new Vector2(7, 0);
            else
                _rb.linearVelocity = new Vector2(-7, 0);
        }
    }
    ...
    {
        yield return new WaitForSeconds(time);
        TimeUnSetSkill03(1.0f);
        _skill03 = false;
        _skill03Dash = false;
    }
    private IEnumerator TimeSkill03Dash(float time)
    {
        yield return new WaitForSeconds(time);
        _photonView.RPC("SetSkill03", RpcTarget.All);
    ...
    private void Skill04()
    {
        ...
        if(Input.GetKeyDown(_keySkill04)  && _attackWaitTime <= 0 && _hitWaitTime <= 0 && !_dash && _timeCooldownSkill04 == 0 && !_skill01 && !_skill02 && !_skill03 && !_skill04 && _isGrounded)
        {
            if(this.gameObject.tag == "Player01")
            {
            ...
            _skill04 = true;
            randomVoice = Random.Range(1, 3);
            GameObject _sound = PhotonNetwork.Instantiate("SkillNaruto/SoundSkill04", transform.position, Quaternion.identity);
            StartCoroutine(DetroyObject(_sound, 5.0f));
            if(randomVoice == 1)
            {
                GameObject _voice = PhotonNetwork.Instantiate("SkillNaruto/VoiceSkill04", transform.position, Quaternion.identity);
                StartCoroutine(DetroyObject(_voice, 5.0f));
            }
            _rb.gravityScale = 0;
            _rb.linearVelocity = new Vector2(0, 0);
            currentState = State.Skill04;
            StartCoroutine(TimeShootSkill04(2.8f));
            StartCoroutine(TimeUnSkill04(3.0f));
        }
    }

    IEnumerator TimeShootSkill04(float time)
    {
        yield return new WaitForSeconds(time);
        if(transform.localScale.x == 1)
            _photonView.RPC("ShowPowerSkill04", RpcTarget.All, new Vector2(transform.position.x + 2.5f, transform.position.y + 1.8f), new Vector2(0.5f, 0.5f), 10.0f);  
        else
            _photonView.RPC("ShowPowerSkill04", RpcTarget.All, new Vector2(transform.position.x - 2.5f, transform.position.y + 1.8f), new Vector2(-0.5f, 0.5f), 10.0f); 
    }
    ...
    [PunRPC]
    private void ShowPowerSkill01(Vector2 newPosition, Vector2 newScale, float timeHitbox, int numKunai)
    {
    ...
    {
        _intrinsicPrefab.SetActive(true);
    }

    [PunRPC]
    private void UnSetIntrinsic()
    {
        _intrinsicPrefab.SetActive(false);
    }

    private IEnumerator TimeUnSetIntrinsic(float time)
    {
        yield return new WaitForSeconds(time);
        _photonView.RPC("UnSetIntrinsic", RpcTarget.All);
    }

    [PunRPC]
    private void SetSkill03()
    {
        _skill03Prefab.SetActive(true);
    ...
    [PunRPC]
    private void UnSetSkill03()
    {
        _skill03Prefab.SetActive(false);
    }

    private void TimeUnSetSkill03(float time)
    {
        _photonView.RPC("UnSetSkill03", RpcTarget.All);
    }
