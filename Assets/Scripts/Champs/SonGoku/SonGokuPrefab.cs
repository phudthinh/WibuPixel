...
public class SonGokuPrefab : MonoBehaviourPunCallbacks
{
    ...
    private bool _directionSkill01 = false;
    ...
    public GameObject _powerSkill01Prefab;
    public GameObject _powerSkill02Prefab;
    public GameObject _powerSkill04Prefab;
    ...
    private void Idle()
    {
        if(_attackWaitTime <= 0 && _hitWaitTime <= 0 && idleTimer < 3.0f && !_dash && !_skill01 && !_skill02 && !_skill03 && !_skill04 && !_intrinsic)
        {
    ...
    private void Stand()
    {
        ...
        else
        {
            ...
            if (idleTimer >= 3.0f && _attackWaitTime <= 0 && _hitWaitTime <= 0 && !_dash && !_skill01 && !_skill02 && !_skill03 && !_skill04 && !_intrinsic)
            {
    ...
    private void MoveLeft()
    {
        ...
        if (Input.GetKey(_keyLeft) && !Input.GetKey(_keyRight)  && _hitWaitTime <= 0 && !_dash && !_skill01 && !_skill02 && !_skill03 && !_skill04 && !_intrinsic)
        {
    ...
    private void MoveRight()
    {
        ...
        if (Input.GetKey(_keyRight) && !Input.GetKey(_keyLeft)  && _hitWaitTime <= 0 && !_dash && !_skill01 && !_skill02 && !_skill03 && !_skill04 && !_intrinsic)
        {
            if(_attackWaitTime <= 0 && _hitWaitTime <= 0)
            {
                currentState = State.Run;
    ...
    private void Jump()
    {
        ...
        if (Input.GetKeyDown(_keyJump) && _hitWaitTime <= 0 && !_skill01 && !_skill02 && !_skill03 && !_skill04 && !_intrinsic)
        {
            if (_isGrounded)
            {
                ...
                if(randomVoice == 1)
                {
                    GameObject _voice = PhotonNetwork.Instantiate("SkillSonGoku/VoiceJump", transform.position, Quaternion.identity);
                    StartCoroutine(DetroyObject(_voice, 5.0f));
                }
                GameObject _sound = PhotonNetwork.Instantiate("SkillSonGoku/SoundJump", transform.position, Quaternion.identity);
    ...
    private void Fall()
    {
        if(!_isGrounded)
        {
            if(_attackWaitTime <= 0 && _hitWaitTime <= 0 && !_dash && !_skill01 && !_skill02 && !_skill03 && !_skill04 && !_intrinsic)
            {
    ...
    private void Attack()
    {
        ...
        AnimationClip clip;
        if(Input.GetKeyDown(_keyAttack) && _attackWaitTime <= 0 && _hitWaitTime <= 0 && !_dash && !_skill01 && !_skill02 && !_skill03 && !_skill04 && !_intrinsic)
        {
            _attackCount++;
            ...
            if(_isGrounded)
            {
                ...
                {
                    randomVoice = Random.Range(1, 3);
                    GameObject _sound = PhotonNetwork.Instantiate("SkillSonGoku/SoundAttack01", transform.position, Quaternion.identity);
                    StartCoroutine(DetroyObject(_sound, 5.0f));
                    if(randomVoice == 1)
                    {
                        GameObject _voice = PhotonNetwork.Instantiate("SkillSonGoku/VoiceAttack01", transform.position, Quaternion.identity);
                        StartCoroutine(DetroyObject(_voice, 5.0f));
                    }
                ...
                {
                    randomVoice = Random.Range(1, 3);
                    GameObject _sound = PhotonNetwork.Instantiate("SkillSonGoku/SoundAttack02", transform.position, Quaternion.identity);
                    StartCoroutine(DetroyObject(_sound, 5.0f));
                    if(randomVoice == 1)
                    {
                        GameObject _voice = PhotonNetwork.Instantiate("SkillSonGoku/VoiceAttack02", transform.position, Quaternion.identity);
                        StartCoroutine(DetroyObject(_voice, 5.0f));
                    }
                ...
                {
                    randomVoice = Random.Range(1, 3);
                    GameObject _sound = PhotonNetwork.Instantiate("SkillSonGoku/SoundAttack03", transform.position, Quaternion.identity);
                    StartCoroutine(DetroyObject(_sound, 5.0f));
                    if(randomVoice == 1)
                    {
                        GameObject _voice = PhotonNetwork.Instantiate("SkillSonGoku/VoiceAttack03", transform.position, Quaternion.identity);
                        StartCoroutine(DetroyObject(_voice, 5.0f));
                    }
                ...
                {
                    randomVoice = Random.Range(1, 3);
                    GameObject _sound = PhotonNetwork.Instantiate("SkillSonGoku/SoundAttack04", transform.position, Quaternion.identity);
                    StartCoroutine(DetroyObject(_sound, 5.0f));
                    if(randomVoice == 1)
                    {
                        GameObject _voice = PhotonNetwork.Instantiate("SkillSonGoku/VoiceAttack04", transform.position, Quaternion.identity);
                        StartCoroutine(DetroyObject(_voice, 5.0f));
                    }
    ...
    public void Hit()
    {
        if(!_dash && !_skill03)
        {
            ...
            if (_hitWaitTime > 0 && !_isHit && !_skill01 && !_skill02 && !_skill04)
            {
                _numHit++;
                if(_numHit > 3)
                {
    ...
    private void Spell()
    {
        if (Input.GetKeyDown(_keySpell) && _timeCooldownSpell == 0 && !_skill01 && !_skill02 && !_skill03 && !_skill04)
        {
            ...
            if(this.gameObject.tag == "Player01")
            {
                ...
                {
                    PhotonNetwork.Instantiate("SpellGame/DashGoku", new Vector2(transform.position.x, transform.position.y + 0.3f), Quaternion.identity);
                    _rb.gravityScale = 0;
                    _rb.linearVelocity = new Vector2(0, 0);
                    transform.position = new Vector2(transform.position.x + 3.0f * transform.localScale.x, transform.position.y);
                    currentState = State.Dash;
                    _dash = true;
                    GameObject _sound = PhotonNetwork.Instantiate("SkillSonGoku/SoundDash", transform.position, Quaternion.identity);
                    StartCoroutine(DetroyObject(_sound, 5.0f));
    ...
    private void Skill01()
    {
        ...
        if(Input.GetKeyDown(_keySkill01)  && _attackWaitTime <= 0 && _hitWaitTime <= 0 && !_dash && _timeCooldownSkill01 == 0 && !_skill01 && !_skill02 && !_skill03 && !_skill04 && !_intrinsic)
        {
            if(this.gameObject.tag == "Player01")
            {
            ...
            _skill01 = true;
            randomVoice = Random.Range(1, 3);
            GameObject _sound = PhotonNetwork.Instantiate("SkillSonGoku/SoundSkill01", transform.position, Quaternion.identity);
            StartCoroutine(DetroyObject(_sound, 5.0f));
            if(randomVoice == 1)
            {
                GameObject _voice = PhotonNetwork.Instantiate("SkillSonGoku/VoiceSkill01", transform.position, Quaternion.identity);
                StartCoroutine(DetroyObject(_voice, 5.0f));
            }
            if(_isGrounded)
            {
                _rb.linearVelocity = new Vector2(0, 0);
                if(_directionSkill01)
                {
                    currentState = State.Skill01A;
                }
                else
                {
                    currentState = State.Skill01B;
                }
            }
            else
            {
                if(_directionSkill01)
                {
                    currentState = State.Skill01C;
                }
                else
                {
                    currentState = State.Skill01D;
                }
            }
            _directionSkill01 = !_directionSkill01;
            StartCoroutine(ShootSkill01(0.1f));
            StartCoroutine(TimeUnSkill01(0.4f));
        }
    }
    IEnumerator ShootSkill01(float time)
    {
        yield return new WaitForSeconds(time);
        if(transform.localScale.x == 1)
            _photonView.RPC("ShowPowerSkill01", RpcTarget.All, new Vector2(transform.position.x + 0.3f, transform.position.y +  0.3f), new Vector2(0.3f, 0.3f), 10.0f);
        else
            _photonView.RPC("ShowPowerSkill01", RpcTarget.All, new Vector2(transform.position.x - 0.3f, transform.position.y +  0.3f), new Vector2(-0.3f, 0.3f), 10.0f);
    }
    ...
    private void Skill02()
    {
        ...
        if(Input.GetKeyDown(_keySkill02)  && _attackWaitTime <= 0 && _hitWaitTime <= 0 && !_dash && _timeCooldownSkill02 == 0  && _isGrounded && !_skill01 && !_skill02 && !_skill03 && !_skill04 && !_intrinsic)
        {
            if(this.gameObject.tag == "Player01")
            {
            ...
            _skill02 = true;
            randomVoice = Random.Range(1, 3);
            GameObject _sound = PhotonNetwork.Instantiate("SkillSonGoku/SoundSkill02", transform.position, Quaternion.identity);
            StartCoroutine(DetroyObject(_sound, 5.0f));
            if(randomVoice == 1)
            {
                GameObject _voice = PhotonNetwork.Instantiate("SkillSonGoku/VoiceSkill02", transform.position, Quaternion.identity);
                StartCoroutine(DetroyObject(_voice, 5.0f));
            }
            _rb.linearVelocity = new Vector2(0, 0);
            currentState = State.Skill02;
            StartCoroutine(ShootSkill02(0.1f));
            StartCoroutine(TimeUnSkill02(0.3f));
        }
    }
    IEnumerator ShootSkill02(float time)
    {
        yield return new WaitForSeconds(time);
        if(transform.localScale.x == 1)
            _photonView.RPC("ShowPowerSkill02", RpcTarget.All, new Vector2(transform.position.x + 0.3f, transform.position.y +  0.3f), new Vector2(0.5f, 0.5f), 10.0f);
        else
            _photonView.RPC("ShowPowerSkill02", RpcTarget.All, new Vector2(transform.position.x - 0.3f, transform.position.y +  0.2f), new Vector2(-0.5f, 0.5f), 10.0f);
    }
    ...
    private void Skill03()
    {
        ...
        if(Input.GetKeyDown(_keySkill03) && _attackWaitTime <= 0 && _hitWaitTime <= 0 && !_dash && _timeCooldownSkill03 == 0 && !_skill01 && !_skill02 && !_skill03 && !_skill04 && !_intrinsic)
        {
            if(this.gameObject.tag == "Player01")
            {
            ...
            _skill03 = true;
            GameObject _sound = PhotonNetwork.Instantiate("SkillSonGoku/SoundSkill03", transform.position, Quaternion.identity);
            StartCoroutine(DetroyObject(_sound, 5.0f));
            _rb.gravityScale = 0;
            _rb.linearVelocity = new Vector2(0, 0);
            currentState = State.Skill03;
            StartCoroutine(MoveSkill03(0.35f));
            StartCoroutine(TimeUnSkill03(1.0f));
        }
    }
    private IEnumerator MoveSkill03(float time)
    {
        yield return new WaitForSeconds(time);
        transform.position = new Vector2(transform.position.x + 4.0f * transform.localScale.x, transform.position.y);
    }
    ...
    private void Skill04()
    {
        ...
        if(Input.GetKeyDown(_keySkill04) && _attackWaitTime <= 0 && _hitWaitTime <= 0 && !_dash && _timeCooldownSkill04 == 0 && !_skill01 && !_skill02 && !_skill03 && !_skill04 && !_intrinsic)
        {
            if(this.gameObject.tag == "Player01")
            {
            ...
            else if(this.gameObject.tag == "Player02")
            {
             ...
             _skill04 = true;
            randomVoice = Random.Range(1, 3);
            GameObject _sound = PhotonNetwork.Instantiate("SkillSonGoku/SoundSkill04", transform.position, Quaternion.identity);
            StartCoroutine(DetroyObject(_sound, 5.0f));
            if(randomVoice == 1)
            {
                GameObject _voice = PhotonNetwork.Instantiate("SkillSonGoku/VoiceSkill04", transform.position, Quaternion.identity);
                StartCoroutine(DetroyObject(_voice, 5.0f));
            }
            if(_isGrounded)
            {
            ...
            StartCoroutine(ShootSkill04(0.6f));
            StartCoroutine(TimeUnSkill04(3.0f));
        }
        if(_skill04)
        {
            _rb.linearVelocity = new Vector2(0, 0);
    ...
    IEnumerator ShootSkill04(float time)
    {
        yield return new WaitForSeconds(time);
        if(transform.localScale.x == 1)
            _photonView.RPC("ShowPowerSkill04", RpcTarget.All, new Vector2(transform.position.x + 0.5f, transform.position.y +  0.3f), new Vector2(0.5f, 0.5f), 2.1f);
        else
            _photonView.RPC("ShowPowerSkill04", RpcTarget.All, new Vector2(transform.position.x - 0.5f, transform.position.y +  0.3f), new Vector2(-0.5f, 0.5f), 2.1f);
    }
    ...
    private void Intrinsic()
    {
        ...
        if(Input.GetKey(_keyIntrinsic))
        {
            if(_attackWaitTime <= 0 && _hitWaitTime <= 0 && !_dash && _timeCooldownIntrinsic == 0 && !_skill01 && !_skill02 && !_skill03 && !_skill04 && _isGrounded)
            {
                _rb.linearVelocity = new Vector2(0, 0);
                currentState = State.Intrinsic;
                _intrinsic = true;
                UpdateIntrinsic(1);
            }
        }
        else if(Input.GetKeyUp(_keyIntrinsic))
        {
            _intrinsic = false;
        }
    }
    ...
    private IEnumerator AddContentSkill()
    {
        ...
        _imageIntrinsic.sprite = Resources.Load<Sprite>("SkillSonGoku/Intrinsic");
        _imageSkill01.sprite = Resources.Load<Sprite>("SkillSonGoku/Skill01");
        _imageSkill02.sprite = Resources.Load<Sprite>("SkillSonGoku/Skill02");
        _imageSkill03.sprite = Resources.Load<Sprite>("SkillSonGoku/Skill03");
        _imageSkill04.sprite = Resources.Load<Sprite>("SkillSonGoku/Skill04");
    ...
    [PunRPC]
    private void ShowPowerSkill01(Vector2 newPosition, Vector2 newScale, float timeHitbox)
    {
        GameObject _powerSkill01 = Instantiate(_powerSkill01Prefab, newPosition, Quaternion.identity);
    ...
    [PunRPC]
    private void ShowPowerSkill02(Vector2 newPosition, Vector2 newScale, float timeHitbox)
    {
        GameObject _powerSkill02 = Instantiate(_powerSkill02Prefab, newPosition, Quaternion.identity);
    ...
    [PunRPC]
    private void ShowPowerSkill04(Vector2 newPosition, Vector2 newScale, float timeHitbox)
    {
        GameObject _powerSkill04 = Instantiate(_powerSkill04Prefab, newPosition, Quaternion.identity);
